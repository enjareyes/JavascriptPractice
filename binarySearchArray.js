...
// value and dividing the search interval in half. The initial interval includes the whole array. 
...
// If the value of the target value is greater than the middle value, then the next 
// interval will be the upper half. The search process repeats until the middle value 
// is equal to the target value, or the search interval is empty.
